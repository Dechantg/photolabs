...
const FavIcon = (props) => {
  ...
  const handleIconClick = () => {
    ...
    // Pass the like status change handling to the parent component
 
  };

  return (
    <button onClick={handleIconClick} className="fav-badge">
      <svg width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        {props.buttonVersion === 'liked' ? (
          // Render the liked heart path
        ...
        {props.displayDot && (
          // add yellow dot for notification in topbar
